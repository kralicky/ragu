...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	for _, method := range service.Methods {
		nilArg := ""
		_, outEmpty := methodUsesEmptypb(method)
		if !method.Desc.IsStreamingClient() && !method.Desc.IsStreamingServer() && !outEmpty {
			nilArg = "nil,"
		}
...
func clientSignature(g *protogen.GeneratedFile, method *protogen.Method) string {
	...
	inEmpty, outEmpty := methodUsesEmptypb(method)
	if !method.Desc.IsStreamingClient() && !inEmpty {
...
func genServerMethod(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, method *protogen.Method) string {
	...
	if !method.Desc.IsStreamingClient() && !method.Desc.IsStreamingServer() {
		...
		g.P("if interceptor == nil { return "+outReturn+"srv.(", service.GoName, "Server).", method.GoName, "(ctx"+inArg+") }")
		...
		args := "(ctx"
		if !inEmpty {
			args += ", req.(*" + g.QualifiedGoIdent(method.Input.GoIdent) + ")"
		}
		args += ")"
		if outEmpty {
			g.P("return out, srv.(", service.GoName, "Server).", method.GoName, args)
		} else {
			g.P("return srv.(", service.GoName, "Server).", method.GoName, args)
		}
		g.P("}")
